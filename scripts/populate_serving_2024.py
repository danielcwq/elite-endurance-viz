...
def populate(args: argparse.Namespace) -> dict[str, object]:
    ...
    try:
        ...
        connection.execute(
            """
            CREATE INDEX idx_activities_athlete_start
                ON activities_2024 (athlete_id, start_at_utc);
            CREATE INDEX idx_performances_athlete_date
                ON performances_2024 (athlete_id, performance_date);
            CREATE INDEX idx_external_accounts_athlete
                ON athlete_external_accounts (athlete_id);
